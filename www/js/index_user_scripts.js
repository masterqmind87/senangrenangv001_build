 ...
 */
 function register_event_handlers()
 {
	...
	function submit_to_joomla(){ 
		...
		$.ajax({
                type: "POST",
                url: "http://user.mydroid.io/aff/afif_front_end/api_login.php",
                data: {
...
function submit_check_first(){
		...
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/aff/afif_front_end/api_registration.php',
			    data: {
			    	'username':jform_username,
			    	'email':jform_email1
...
function submit_to_joomla2(name,username,password1,password2,email1,email2,option,task){
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/aff/index.php', //url of joomla website
			    data: {
			    	'option': option,
			    	'task': task,
			    	'jform[name]':name,
     ...
     // pull data from sql for feedback 

          $( document ).ready(function() {
          $.ajax({
            url: 'http://user.mydroid.io/aff/api.php?private_key=e4ed5acb3a53e3935a1a8f1676fb111de2a4842a',
            type: "get",
            dataType: "json",
            success: function(response) {
    ...
    {
          var $form = $( this ),
      url = "http://user.mydroid.io/aff/afif.php";
